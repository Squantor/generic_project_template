...
void (*const vendor_vector_table[])(void) __attribute__((used, section(".vendor_vectors"))) = {
  ...
  DMA1_Channel2_IRQHandler,  DMA1_Channel3_IRQHandler, DMA1_Channel4_IRQHandler, DMA1_Channel5_IRQHandler,
  DMA1_Channel6_IRQHandler,  DMA1_Channel7_IRQHandler, ADC1_2_IRQHandler,        USB_HP_CAN_TX_IRQHandler,
  ...
  EXTI15_10_IRQHandler,      RTCAlarm_IRQHandler,      USBWakeup_IRQHandler,     TIM8_BRK_IRQHandler,
  ...
  UART4_IRQHandler,          UART5_IRQHandler,         TIM6_IRQHandler,          TIM7_IRQHandler,
