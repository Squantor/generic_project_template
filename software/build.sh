...
make -j18 PROJECT=LPC812M101DH20_empty CONFIG=release
make -j18 PROJECT=LPC812M101DH20_empty CONFIG=debug
make -j18 PROJECT=LPC812M101DH20_blinky CONFIG=release
...
make -j18 PROJECT=LPC824M201HI33_empty CONFIG=release
make -j18 PROJECT=LPC824M201HI33_empty CONFIG=debug
make -j18 PROJECT=LPC824M201HI33_blinky CONFIG=release
make -j18 PROJECT=LPC824M201HI33_blinky CONFIG=debug
make -j18 PROJECT=LPC844M201BD64_empty CONFIG=release
make -j18 PROJECT=LPC844M201BD64_empty CONFIG=debug
make -j18 PROJECT=LPC845M301BD48_empty CONFIG=release
make -j18 PROJECT=LPC845M301BD48_empty CONFIG=debug
make -j18 PROJECT=LPC845M301BD48_blinky CONFIG=release
make -j18 PROJECT=LPC845M301BD48_blinky CONFIG=debug
make -j18 PROJECT=LPC1114BD48_323_empty CONFIG=release
make -j18 PROJECT=LPC1114BD48_323_empty CONFIG=debug
make -j18 PROJECT=LPC1125BD48_303_empty CONFIG=release
make -j18 PROJECT=LPC1125BD48_303_empty CONFIG=debug
make -j18 PROJECT=STM32F030K6_blinky CONFIG=release
make -j18 PROJECT=STM32F030K6_blinky CONFIG=debug
make -j18 PROJECT=STM32F031K6_blinky CONFIG=release
